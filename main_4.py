...
async def support(ctx):
    embed=discord.Embed(title="Support Server", url="https://discord.gg/4EEuUFz", description="Click On Link Above To Join!", color=0xe548ab)
    embed.set_author(name="Cheapest HQ Life Server", url="https://discord.gg/4EEuUFz")
    embed.set_thumbnail(url="https://deifoexkvnt11.cloudfront.net/assets/article/2020/02/17/1200x630wa-feature_feature.png")
    await ctx.send(embed=embed)

@bot.command()
async def invite(ctx):
    embed=discord.Embed(title="Invite Bot!", url="https://discord.com/api/oauth2/authorize?client_id=766621511540146186&permissions=0&scope=bot", description="Click On Link Above To Join!", color=0xe548ab)
    embed.set_author(name="Cheapest HQ Life Server", url="https://discord.gg/4EEuUFz")
    embed.set_thumbnail(url="https://deifoexkvnt11.cloudfront.net/assets/article/2020/02/17/1200x630wa-feature_feature.png")
    await ctx.send(embed=embed)
...
async def buy(ctx):
    ...
    if content.isdigit() and int(content):
        ...
        embed.set_image(url="https://cdn.discordapp.com/attachments/739860882536005734/766879273922330624/Screenshot_20201014-170116.png")
        await ctx.author.send(embed=embed)
...
bot.run('Nzc1MzgwMjA4MTY5MjU0OTQy.X6lfFw.8pcx2Aq2ZA21OTrIcx_D11Rsf7g')
